...
urso = "https://i.imgur.com/I0dkl5H.jpg"
indio ="https://i.imgur.com/WKHtsNn.jpg"
indios ="https://i.imgur.com/lJHFgcr.jpg"
...
#CHAMA O ELEMENTO URSO E O TEXTO 
    elementourso = Elemento(img = urso, 
                     tit = "Urso Marrom", 
                     style = dict (top = 420, left = 25, height = 138, width = 138, bottom = 100))
...
#CHAMA O ELEMENTO INDIO E O TEXTO 
    elementoindio = Elemento(img = indio, 
                     tit = "Indio", 
                     style = dict (top = 400, left = 190, height = 100, width = 100))
