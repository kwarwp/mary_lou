...
ciencia = "https://i.imgur.com/gz8Eu7T.jpg"
urso = "https://i.imgur.com/S6bZsL0.png"
indio ="https://i.imgur.com/m3J3svz.png"
indios ="https://i.imgur.com/fl1M9lP.png"
...
#CHAMA O ELEMENTO URSO E O TEXTO 
    elementourso = Elemento(img = urso, 
                     tit = "Urso Marrom", 
                     style = dict (top = 360, left = 30, height = 400, width = 200, bottom = 100))
...
#CHAMA O ELEMENTO INDIO E O TEXTO 
    ...
    elementoindios = Elemento(img = indios, 
                     tit = "Indio", 
                     style = dict (top = 420, left = 300, height = 100, width = 200))
